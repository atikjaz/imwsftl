...
async def private_receive_handler(c: Client, m: Message):
    ...
    if check_pass== None:
        await m.reply_text("Login first using /login cmd \n don\'t know the pass? request it from https://t.me/+U-uFekBLLLXsEijR")
        return
    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            if user.status == "kicked":
                await c.send_message(
                    chat_id=m.chat.id,
                    text="__SORRY SIR, YOU ARE BANNED TO USE ME.__\n\n  **CONTACT DEVELOPER https://t.me/+U-uFekBLLLXsEijR HE WILL HELP YOU**",
                    parse_mode="markdown",
            ...
            await c.send_message(
                chat_id=m.chat.id,
                text="**SOMETHING WENT WRONG. CONTACT SUPPORT** https://t.me/+U-uFekBLLLXsEijR",
                parse_mode="markdown",
                disable_web_page_preview=True)
            return
    try:
